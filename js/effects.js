...
function setupParticles() {
  ...
  {
    // Dies ist Ihre Konfiguration für die Partikel
    "particles": {
      "number": {
        "value": 80,
        "density": {
  ...
  // Dies ist die wichtige Callback-Funktion
  function() {
    console.log('Partikel-Animation ist jetzt bereit.');
    
    // Rufen Sie HIER die Funktion auf, die das Theme und die Farben anwendet.
