                ...
                let previewHtml = `
                    <div class="preview-landingpage" style="color: #f0f0f0; line-height: 1.6; background: linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 100%); padding: 20px; border-radius: 10px;">
                        <header style="text-align: center; margin-bottom: 40px; padding: 30px 0; border-bottom: 2px solid #ffc107;">
                            ...
                            <p style="font-size: 1.2rem; color: #ccc; ...">${data.hero_text || 'N/A'}</p>
                            <p style="font-size: 1rem; color: #aaa; ...">${data.hero_subtext || ''}</p>
                            <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
                                <button style="...">${data.primary_cta || 'N/A'}</button>
                                <button style="...">${data.secondary_cta || 'N/A'}</button>
                            </div>
                        </header>
                        <main style="max-width: 1000px; margin: 0 auto;">
                            <section style="..."><h2 style="color: #ff6b6b; ...">${data.h2_1 || 'N/A'}</h2>...</section>
                            <section style="..."><h2 style="color: #28a745; ...">${data.h2_2 || 'N/A'}</h2>...</section>
                            <section style="..."><div style="..."><h3 style="...">${data.h2_3 || 'N/A'}</h3><div style="color: #ccc;">${data.features_list || ''}</div></div><div style="..."><h3 style="...">Vorteile</h3><div style="color: #ccc;">${data.benefits_list || ''}</div></div></section>
                            <section style="..."><h2 style="color: #17a2b8; ...">${data.h2_4 || 'N/A'}</h2><p style="...">${data.social_proof || ''}</p><p style="...">${data.trust_signals || ''}</p></section>
                            <section style="..."><h3 style="...">Kundenstimmen</h3><div style="..."><div style="..."><p style="...">${data.testimonial_1 || ''}</p></div><div style="..."><p style="...">${data.testimonial_2 || ''}</p></div></div></section>
                            <section style="..."><h3 style="...">${data.pricing_title || 'N/A'}</h3><div style="..."><div style="..."><h4 style="...">Starter</h4><p style="...">${data.price_1 || ''}</p></div><div style="..."><h4 style="...">Professional</h4><p style="...">${data.price_2 || ''}</p></div><div style="..."><h4 style="...">Enterprise</h4><p style="...">${data.price_3 || ''}</p></div></div></section>
                            <section style="..."><h3 style="...">Häufige Fragen</h3><div style="..."><details style="..."><summary style="...">${data.faq_1 || 'N/A'}</summary><p style="...">${data.faq_answer_1 || ''}</p></details><details style="..."><summary style="...">${data.faq_2 || 'N/A'}</summary><p style="...">${data.faq_answer_2 || ''}</p></details><details style="..."><summary style="...">${data.faq_3 || 'N/A'}</summary><p style="...">${data.faq_answer_3 || ''}</p></details></div></section>
                            <section style="..."><h3 style="...">${data.guarantee_text || 'N/A'}</h3><p style="...">${data.contact_info || ''}</p><button style="...">${data.footer_cta || 'N/A'}</button></section>
                        </main>
                        <aside style="..."><h3 style="...">📊 SEO & Meta-Informationen</h3><div style="..."><div style="..."><strong style="...">🎯 SEO Titel:</strong><span style="...">${data.meta_title || data.post_title || 'N/A'}</span></div></div><div style="..."><div style="..."><strong style="...">🔗 URL Slug:</strong><span style="...">...</span></div></div><div style="..."><div style="..."><strong style="...">📝 Meta Description:</strong><span style="...">${data.meta_description || 'N/A'}</span></div></div></aside>
                    </div>
                `;
